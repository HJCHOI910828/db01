    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <div class="container">
        ...
        <table class="table table-bordered">
          <tr>
            <td>글쓴이</td>
            <td><input type="text" name="writer" value="<?=$id?>" readonly size=30></td>
          </tr>
          <tr>
            <td>글제목</td>
            <td><input type="text" name="title" placeholder="글제목" size=30></td>
          </tr>
          <tr>
            <td>글내용</td>
            <td><textarea name="content" rows="10" cols="50" placeholder="글내용" style="resize: none"></textarea></td>
          </tr>
          <tr>
